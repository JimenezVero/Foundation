...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { articulo: @ventum.articulo, cliente: @ventum.cliente, precio: @ventum.precio } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { articulo: @ventum.articulo, cliente: @ventum.cliente, precio: @ventum.precio } }
